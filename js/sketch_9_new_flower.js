...
//////////////////////////////////////////
//the new organe jasmine
//the following flowers are referenced from "flowers" by son on p5.js website
...
ellipse(86, 79, 105, 125); 
      ellipse(65, 90, 105, 135);
   ellipse(136, 76, 105, 123);
   ellipse(146, 79, 105, 135); 
      ellipse(65, 90, 105, 125);
   ellipse(106, 76, 105, 133);
  ellipse(127, 136, 105, 125);
  ellipse(128, 149, 105, 135);
   ellipse(106, 159, 105, 123);
    ellipse(101, 169, 105, 130);
      ellipse(73, 152, 105, 125);
  ellipse(100, 162, 106, 133);
  ellipse(140, 150, 135, 125);
   ellipse(130, 140, 135, 125);
  ellipse(157, 119, 105, 130);
  ellipse(117, 110, 105, 125);
    ellipse(58, 105, 105, 135);
 
  ellipse(86, 79, 95, 105); 
      ellipse(65, 90, 95, 105);
   ellipse(106, 76, 95, 103);
   ellipse(86, 79, 95, 115); 
      ellipse(65, 90, 95, 105);
   ellipse(106, 76, 95, 103);
  ellipse(127, 136, 95, 105);
  ellipse(118, 149, 95, 115);
   ellipse(106, 159, 105, 103);
    ellipse(91, 159, 95, 100);
      ellipse(73, 152, 95, 105);
  ellipse(63, 142, 96, 103);
   ellipse(59, 130, 100, 105);
  ellipse(57, 119, 95, 100);
  ellipse(57, 110, 95, 105);
    ellipse(58, 105, 100, 105);
   //outside 1 petals

    ellipse(86, 79, 45, 55); 
      ellipse(65, 90, 55, 55);
   ellipse(106, 76, 45, 53);
   ellipse(126, 96, 45, 55);
    ellipse(127, 120, 55, 55);
  ellipse(127, 136, 55, 55);
  ellipse(118, 149, 55, 55);
   ellipse(106, 159, 45, 53);
    ellipse(91, 159, 55, 55);
    ellipse(73, 152, 55, 55);
  ellipse(63, 142, 46, 53);
   ellipse(59, 130, 55, 55);
  ellipse(57, 119, 55, 55);
  ellipse(57, 110, 45, 55);
   ellipse(58, 105, 55, 55);
